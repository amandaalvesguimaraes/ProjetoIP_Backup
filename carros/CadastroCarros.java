...
public class CadastroCarros {
    ...
    public void atualizar(Carros carro, String pa) throws PEException, CCException, PNEException, QPIException, PDIException, ANException { //p � a nova placa e pa � a placa antiga
